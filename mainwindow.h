...
{
    Q_OBJECT private: RehreshThread * rehreshThread; int n; process ** proc;
    int * pids; pthread_t mainthread; ProcTableModel * model; int flags[8]; int
    sotrFlag[8]; USER_FILTER userFilter; STATE_FILTER stateFilter; char *
    nfilter; CPU * cpu_used;
    QLabel ** cpux;
    QProgressBar ** cpuxP;
public:
